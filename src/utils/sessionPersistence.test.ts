...
describe('sessionPersistence', () => {
  const testSessionDir = join(process.env.TEMP_DIR ?? '/tmp', 'soteria-test-sessions')

  beforeEach(async () => {
    process.env.SOTERIA_TEST_SESSIONS_DIR = testSessionDir
  ...
  afterEach(() => {
    delete process.env.SOTERIA_TEST_SESSIONS_DIR
  })
