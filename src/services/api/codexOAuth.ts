...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to Soteria now.</p>
    <p>Soteria will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in Soteria.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in Soteria.</p>
  </body>
</html>`
}
