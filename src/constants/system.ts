...
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX =
  `You are Soteria, a general-purpose assistant and CLI with strong cybersecurity analysis capabilities, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX =
  `You are Soteria, a general-purpose assistant and CLI with strong cybersecurity analysis capabilities, built on the Claude Agent SDK.`
