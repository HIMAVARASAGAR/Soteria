...
const PROTO_PATH = path.resolve(import.meta.dirname, '../proto/soteria.proto')
...
const soteriaProto = protoDescriptor.soteria.v1
...
export class GrpcServer {
  ...
  constructor() {
    ...
    this.server.addService(soteriaProto.AgentService.service, {
      ...
      try {
        if (clientMessage.request) {
          ...
          engine = new QueryEngine({
            ...
            mcpClients: [],
            // Register Soteria's built-in agents (general-purpose,
