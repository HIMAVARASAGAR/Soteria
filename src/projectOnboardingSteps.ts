...
export function getSteps(): Step[] {
  ...
  return [
    {
      key: 'workspace',
      text: 'Ask Soteria to create a new app or clone a repository',
      isComplete: false,
      isCompletable: true,
    ...
    {
      key: 'claudemd',
      text: 'Set up repo instructions (/init creates SOTERIA.md, AGENTS.md or updates existing CLAUDE.md; any file counts)',
