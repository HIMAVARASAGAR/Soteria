...
let localState = {
  ...actualConfig.DEFAULT_GLOBAL_CONFIG,
  knowledgeGraphEnabled: true,
}

mock.module('../../utils/config.js', () => ({
  ...actualConfig,
  getGlobalConfig: () => localState,
  saveGlobalConfig: (updater: (current: typeof localState) => typeof localState) => {
...
describe('knowledge command', () => {
  ...
  beforeEach(async () => {
    ...
    configDir = mkdtempSync(join(tmpdir(), 'soteria-knowledge-command-'))
