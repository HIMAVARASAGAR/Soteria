export const vi = {
  ...
  'commands.doctor.description':
    'Chẩn đoán và xác minh cài đặt Soteria',
  ...
  'commands.insights.description':
    'Tạo báo cáo phân tích các phiên Soteria',
  ...
  'commands.plugin.description': 'Quản lý plugin Soteria',
  ...
  'commands.stats.description':
    'Hiện thống kê sử dụng và hoạt động Soteria',
  'commands.status.description':
    'Hiển thị trạng thái Soteria bao gồm phiên bản, mô hình, tài khoản, kết nối API và trạng thái công cụ',
  'commands.statusline.description':
    'Thiết lập giao diện dòng trạng thái của Soteria',
  'commands.stickers.description': 'Đặt mua sticker Soteria',
  ...
  'commands.wiki.description':
    'Khởi tạo và kiểm tra wiki dự án Soteria',
