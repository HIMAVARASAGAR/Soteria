export const en = {
  ...
  'commands.doctor.description':
    'Diagnose and verify your Soteria installation and settings',
  ...
  'commands.insights.description':
    'Generate a report analyzing your Soteria sessions',
  ...
  'commands.plugin.description': 'Manage Soteria plugins',
  ...
  'commands.stats.description':
    'Show your Soteria usage statistics and activity',
  'commands.status.description':
    'Show Soteria status including version, model, account, API connectivity, and tool statuses',
  'commands.statusline.description': "Set up Soteria's status line UI",
  'commands.stickers.description': 'Order Soteria stickers',
  ...
  'commands.wiki.description':
    'Initialize and inspect the Soteria project wiki',
