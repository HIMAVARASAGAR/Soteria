...
import { BRAND_ACCENT_RGB, BRAND_NAME } from '../../constants/brand.js';
...
export function CondensedLogo() {
  ...
  if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Text color={BRAND_ACCENT_RGB}>●</Text>;
    $[7] = t4;
  } else {
    t4 = $[7];
  }
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = <Text bold={true} color={BRAND_ACCENT_RGB}>{BRAND_NAME}</Text>;
    $[8] = t5;
  } else {
    t5 = $[8];
  }
  ...
  if ($[23] !== t10 || $[24] !== t11 || $[25] !== t6 || $[26] !== t7 || $[27] !== t9) {
    t12 = <OffscreenFreeze><Box borderStyle="round" borderColor="inactive" paddingX={2} paddingY={0} flexDirection="column"><Text>{t4} {t6}</Text><Box flexDirection="column">{t7}{t9}<Text dimColor={true}>/model to switch models · /help for commands</Text></Box>{t10}{t11}</Box></OffscreenFreeze>;
    $[23] = t10;
    $[24] = t11;
    $[25] = t6;
    $[26] = t7;
