...
export function ModelPicker(t0) {
  ...
  const t16 = headerText ?? "Switch between Claude models. Applies to this session and future Soteria sessions. For other/previous model names, specify with --model.";
  let t17;
  if ($[42] !== t16) {
...
function resolveOptionModel(value?: string): string | undefined {
  ...
  const cleanValue = colonIndex === -1 ? value : value.slice(colonIndex + 1);
  return cleanValue === NO_PREFERENCE ? getDefaultMainLoopModel() : parseUserSpecifiedModel(cleanValue);
}
