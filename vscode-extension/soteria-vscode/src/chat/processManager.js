/**
 * ProcessManager — spawns Soteria in print/SDK mode and manages the
...
class ProcessManager {
  /**
   * @param {object} opts
   * @param {string} opts.command - The soteria binary (e.g. 'soteria')
   ...
   */
  constructor(opts) {
    this._command = opts.command || 'soteria';
