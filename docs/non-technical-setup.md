# Soteria for Non-Technical Users
...
Soteria lets you use an AI coding assistant with different model providers such as:
...
After you run `soteria`, the CLI should start and wait for your prompt.
