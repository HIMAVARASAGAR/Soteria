...
export const commands: SlashCommand[] = [
  ...
  { name: 'wiki', description: 'Initialize and inspect the Soteria project wiki', category: 'context', args: '[init|status]' },
  ...
  { name: 'plugin', description: 'Manage Soteria plugins', category: 'tools' },
  ...
  { name: 'statusline', description: "Set up Soteria's status line UI", category: 'customization' },
  ...
  { name: 'stickers', description: 'Order Soteria stickers', category: 'customization' },
  ...
  { name: 'doctor', description: 'Diagnose and verify your Soteria installation and settings', category: 'diagnostics' },
  { name: 'stats', description: 'Show your usage statistics and activity', category: 'diagnostics' },
  { name: 'insights', description: 'Generate a report analyzing your Soteria sessions', category: 'diagnostics' },
  { name: 'release-notes', description: 'View release notes', category: 'diagnostics' },
  { name: 'feedback', description: 'Submit feedback about Soteria', category: 'diagnostics', args: '[report]' },
]
