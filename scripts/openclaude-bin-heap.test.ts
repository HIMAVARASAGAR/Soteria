...
const BIN_PATH = join(import.meta.dir, '..', 'bin', 'soteria')

describe('soteria launcher heap guard', () => {
  ...
  test('keeps user and troubleshooting escape hatches', () => {
    ...
    expect(source).toContain('SOTERIA_DISABLE_HEAP_RELAUNCH')
    expect(source).toContain('SOTERIA_NODE_MAX_OLD_SPACE_SIZE_MB')
