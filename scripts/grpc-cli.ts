...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/soteria.proto')
...
async function main() {
  ...
  const client = new soteriaProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mSoteria gRPC CLI\x1b[0m')
